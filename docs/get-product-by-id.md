...
title: get one product Product API
sidebar_label: get one product Product API
---

# get one product Product API

The get one product Product API endpoint allows you to add a new product to your store in EasyOrders.
...
- **Method**: GET
- **URL**: `https://api.easy-orders.net/api/v1/external-apps/products/:product_id`
...
```json
{
  ...
  "description": "<p><br></p><p>ترنج اديداس 3 الوان مقاسات لارج و اكس لارج و 2 اكس لارج</p><p><br></p><iframe class=\"ql-video\" frameborder=\"0\" allowfullscreen=\"true\" src=\"https://www.youtube.com/embed/Ibjm2KHfymo?showinfo=0\"></iframe><p><br></p>",
